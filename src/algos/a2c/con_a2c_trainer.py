# -*- encoding: utf-8 -*-
'''
@File       :con_a2c_trainer.py
@Description:Continuous A2C (Advantage Actor-Critic) Algorithm Trainer
@Date       :2025/04/24
@Author     :Trae
@Version    :python
'''
...
class ContinuousA2CTrainer(BaseTrainer):
    ...
    def update(self, data):
        """
        Perform one update step for Continuous A2C
        """
