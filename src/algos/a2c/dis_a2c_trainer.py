# -*- encoding: utf-8 -*-
'''
@File       :dis_a2c_trainer.py
@Description:Discrete A2C (Advantage Actor-Critic) Algorithm Trainer
@Date       :2025/04/24
@Author     :Trae
@Version    :python
'''
...
class DiscreteA2CTrainer(BaseTrainer):
    ...
    def update(self, data):
        """
        Perform one update step for Discrete A2C
        """
